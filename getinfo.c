 ...
 * @info: Address of the struct info_t to be cleared.
 */
...
/**
 * set_info - Initializes the info_t struct with command arguments.
 * @info: Address of the struct info_t to be initialized.
 ...
 * @info: Address of the struct info_t to be freed.
